...
//make sure edit pot nutton was clicked
if(isset($_POST['submit'])){
    ...
    // set is_fatured to 0 if it was unchecked
    $is_featured = $is_featured == 1 ?: 0;

    // chec and validate input values
    if(!$title){
    ...
    if($_SESSION['edit-post']){
        ...
        header('loaction: ' . ROOT_URL . 'Admin/');
        die();
    }else{
        ...
        //set thumbnail name ifa new one was uploaded, else keep old thumbnail name
